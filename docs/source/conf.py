...
os.environ['DYLD_LIBRARY_PATH'] = '/Users/melekderman/github/BFP/PyMFEM/external/mfem/cmbuild_par:' + os.environ.get('DYLD_LIBRARY_PATH', '')
...
exclude_patterns = []
autodoc_mock_imports = ["mfem", "mpi4py", "setup"]
